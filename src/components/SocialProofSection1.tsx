...
export function SocialProofSection1() {
  ...
  return (
    <section className="pt-24 bg-gray-50 dark:bg-gray-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
          <h2 className="font-semibold text-[#FE8D2A] text-4xl sm:text-5xl lg:text-6xl mb-6">
            One-Sentence
            <span className="text-[#FFFFFF]"> Stories From People Who Have Built Better Habits </span>
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-400">
            1,000+ people used this system to rebuild their habits and reclaim their discipline.
          </p>
        </div>
