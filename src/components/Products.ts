...
const THE_HABIT_JUMPSTART = `https://livelifesuccessfull.gumroad.com/l/${process.env.THE_HABIT_JUMPSTART}`;
const NEURAL_REWIRE_BLUEPRINT = `https://livelifesuccessfull.gumroad.com/l/${process.env.NEURAL_REWIRE_BLUEPRINT}`;
const HABIT_TRANSFORMATION_OS = `https://livelifesuccessfull.gumroad.com/l/${process.env.HABIT_TRANSFORMATION_OS}`;
